var pedigreejs = (function (exports) {
	...
	**/
	...
	$(document).on('fhChange', function (e, opts) {
	  ...
	  // send updated JSON back to R
	  //Shiny.setInputValue("pedJSout2", JSON.stringify(opts.dataset));

    //$(document).querySelectorAll(".addchild").addEventListener(
    //  "click", 
    //  function(){
    //    Shiny.setInputValue("pedJSout2", JSON.stringify(pedigreejs.pedcache.current(opts)));
    //  }
    //);
